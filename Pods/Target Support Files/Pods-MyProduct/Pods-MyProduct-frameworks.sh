...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MFAlertController/MFAlertController.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MFNetworkRequest/MFNetworkRequest.framework"
