    ...
    */
    ...
    private func fetchData(for identifier: UUID) {
        ...
        if let data = fetchedData(for: identifier) {
            ...
            let operation = CollectionAsyncFetcherOperation(identifier: identifier)
     ...
     */
    private func operation(for identifier: UUID) -> CollectionAsyncFetcherOperation? {
        for case let fetchOperation as CollectionAsyncFetcherOperation in fetchQueue.operations
