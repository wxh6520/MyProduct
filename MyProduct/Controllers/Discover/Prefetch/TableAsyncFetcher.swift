    ...
    */
    ...
    private func fetchData(for identifier: UUID) {
        ...
        if let data = fetchedData(for: identifier) {
            ...
            let operation = TableAsyncFetcherOperation(identifier: identifier)
     ...
     */
    private func operation(for identifier: UUID) -> TableAsyncFetcherOperation? {
        for case let fetchOperation as TableAsyncFetcherOperation in fetchQueue.operations
